          ...
          <div className={styles.heroImageContainer}>
            <div className={styles.productInfo}>
              ...
              <p className={styles.productDescription}>
                FutureWatch is your essential crypto terminal. Track real-time liquidations, ETF inflows, options activity, and key macro signals—all unified in one dashboard. Cut through the noise and gain clarity on the flows that matter.
              </p>
            </div>
          </div>
        </div>
